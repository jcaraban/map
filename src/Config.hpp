...
struct Config {
	...
	const int max_io_block = max_in_block + max_out_block;
	...
	const size_t def_cache_block_size = max_io_block * max_num_ranks * sizeof(double);
	const size_t def_cache_group_size = max_group_x_block * def_cache_block_size;
