...
S_TASK = $(addprefix runtime/task/, Task.cpp LocalTask.cpp ScalarTask.cpp FocalTask.cpp ZonalTask.cpp FocalZonalTask.cpp RadialTask.cpp SpreadTask.cpp LoopTask.cpp StatsTask.cpp IdentityTask.cpp)
S_SKEL = $(addprefix runtime/skeleton/, util.cpp Skeleton.cpp LocalSkeleton.cpp FocalSkeleton.cpp CpuFocalSkeleton.cpp ZonalSkeleton.cpp FocalZonalSkeleton.cpp RadialSkeleton.cpp SpreadSkeleton.cpp)
...
H_DAG  = $(addprefix runtime/dag/, dag.hpp util.hpp Node.hpp Group.hpp Constant.hpp Index.hpp Identity.hpp Rand.hpp Cast.hpp Unary.hpp Binary.hpp Conditional.hpp Diversity.hpp Neighbor.hpp BoundedNeighbor.hpp SpreadNeighbor.hpp Convolution.hpp FocalFunc.hpp FocalPercent.hpp ZonalReduc.hpp RadialScan.hpp SpreadScan.hpp IO.hpp Read.hpp Write.hpp Scalar.hpp Temporal.hpp Access.hpp LhsAccess.hpp Summary.hpp BlockSummary.cpp Barrier.hpp Checkpoint.hpp LoopCond.hpp LoopHead.hpp LoopTail.hpp Merge.hpp Switch.hpp)
...
H_TASK = $(addprefix runtime/task/, Task.hpp LocalTask.hpp ScalarTask.hpp FocalTask.hpp ZonalTask.hpp FocalZonalTask.hpp RadialTask.hpp SpreadTask.hpp LoopTask.hpp StatsTask.hpp IdentityTask.hpp)
H_SKEL = $(addprefix runtime/skeleton/, util.hpp Skeleton.hpp LocalSkeleton.hpp FocalSkeleton.hpp CpuFocalSkeleton.hpp ZonalSkeleton.hpp FocalZonalSkeleton.hpp RadialSkeleton.hpp SpreadSkeleton.hpp)
