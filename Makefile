...
S_RUNT = $(addprefix runtime/, Runtime.cpp Clock.cpp Program.cpp Cache.cpp Scheduler.cpp Worker.cpp Job.cpp Entry.cpp Block.cpp Pattern.cpp Version.cpp ThreadId.cpp LoopAssembler.cpp)
...
H_RUNT = $(addprefix runtime/, Runtime.hpp Config.hpp Clock.hpp Program.hpp Cache.hpp Scheduler.hpp Worker.hpp Job.hpp Entry.hpp Block.hpp Pattern.hpp Version.hpp ThreadId.hpp LoopAssembler.hpp)
H_DAG  = $(addprefix runtime/dag/, dag.hpp util.hpp Node.hpp Group.hpp Constant.hpp Index.hpp Identity.hpp Rand.hpp Cast.hpp Unary.hpp Binary.hpp Conditional.hpp Diversity.hpp Neighbor.hpp BoundedNbh.hpp SpreadNeighbor.hpp Convolution.hpp FocalFunc.hpp FocalPercent.hpp FocalFlow.hpp ZonalReduc.hpp RadialScan.hpp SpreadScan.cpp IO.hpp Read.hpp Write.hpp Scalar.hpp Temporal.hpp Access.hpp LhsAccess.hpp Stats.hpp Barrier.hpp Checkpoint.hpp LoopCond.hpp LoopHead.hpp LoopTail.hpp Merge.hpp Switch.hpp)
