...
S_DAG  = $(addprefix runtime/dag/, dag.cpp util.cpp Node.cpp Group.cpp Constant.cpp Index.cpp Identity.cpp Rand.cpp Cast.cpp Unary.cpp Binary.cpp Conditional.cpp Diversity.cpp Neighbor.cpp BoundedNbh.cpp SpreadNeighbor.cpp Convolution.cpp FocalFunc.cpp FocalPercent.cpp ZonalReduc.cpp RadialScan.cpp SpreadScan.cpp IO.cpp Read.cpp Write.cpp Scalar.cpp Temporal.cpp Access.cpp LhsAccess.cpp Stats.cpp Barrier.cpp Checkpoint.cpp LoopCond.cpp LoopHead.cpp LoopTail.cpp Merge.cpp Switch.cpp)
S_VISI = $(addprefix runtime/visitor/, Visitor.cpp SimplifierOnline.cpp Fusioner.cpp Exporter.cpp Lister.cpp Sorter.cpp Predictor.cpp Partitioner.cpp Cloner.cpp)
S_TASK = $(addprefix runtime/task/, Task.cpp LocalTask.cpp ScalarTask.cpp FocalTask.cpp ZonalTask.cpp FocalZonalTask.cpp RadiatingTask.cpp SpreadingTask.cpp LoopTask.cpp StatsTask.cpp IdentityTask.cpp)
...
H_DAG  = $(addprefix runtime/dag/, dag.hpp util.hpp Node.hpp Group.hpp Constant.hpp Index.hpp Identity.hpp Rand.hpp Cast.hpp Unary.hpp Binary.hpp Conditional.hpp Diversity.hpp Neighbor.hpp BoundedNbh.hpp SpreadNeighbor.hpp Convolution.hpp FocalFunc.hpp FocalPercent.hpp ZonalReduc.hpp RadialScan.hpp SpreadScan.hpp IO.hpp Read.hpp Write.hpp Scalar.hpp Temporal.hpp Access.hpp LhsAccess.hpp Stats.hpp Barrier.hpp Checkpoint.hpp LoopCond.hpp LoopHead.hpp LoopTail.hpp Merge.hpp Switch.hpp)
H_VISI = $(addprefix runtime/visitor/, Visitor.hpp SimplifierOnline.hpp Fusioner.hpp Exporter.hpp Lister.hpp Sorter.hpp Predictor.hpp Partitioner.hpp Cloner.hpp)
H_TASK = $(addprefix runtime/task/, Task.hpp LocalTask.hpp ScalarTask.hpp FocalTask.hpp ZonalTask.hpp FocalZonalTask.hpp RadiatingTask.hpp SpreadingTask.hpp LoopTask.hpp StatsTask.hpp IdentityTask.hpp)
