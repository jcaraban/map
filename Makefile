...
S_TASK = $(addprefix runtime/task/, Task.cpp ScalarTask.cpp RadialTask.cpp SpreadTask.cpp LoopTask.cpp StatsTask.cpp IdentityTask.cpp)
S_SKEL = $(addprefix runtime/skeleton/, util.cpp Skeleton.cpp RadialSkeleton.cpp)
...
H_TASK = $(addprefix runtime/task/, Task.hppScalarTask.hpp RadialTask.hpp SpreadTask.hpp LoopTask.hpp StatsTask.hpp IdentityTask.hpp)
H_SKEL = $(addprefix runtime/skeleton/, util.hpp Skeleton.hpp RadialSkeleton.hpp)
