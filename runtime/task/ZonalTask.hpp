...
#ifndef MAP_RUNTIME_TASK_ZONAL_HPP_
#define MAP_RUNTIME_TASK_ZONAL_HPP_
...
struct ZonalTask : public Task
{
	ZonalTask(Program &prog, Clock &clock, Config &conf, Group *group);
	/*
	void createVersions();
